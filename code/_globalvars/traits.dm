...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_BLING_LOVER" = TRAIT_BLING_LOVER,
		...
		"TRAIT_PURE_HUMAN" = TRAIT_PURE_HUMAN,
		...
		"TRAIT_POORHYGINE" = TRAIT_POORHYGINE,
		"TRAIT_SMALLSPRINT" = TRAIT_SMALLSPRINT,
		...
		"TRAIT_NARCOLEPTIC" = TRAIT_NARCOLEPTIC,
		"TRAIT_LIGHT_STEP" = TRAIT_LIGHT_STEP,
		"TRAIT_PAIN_TRAIN" = TRAIT_PAIN_TRAIN,
		...
		"TRAIT_WILD_HUNTER" = TRAIT_WILD_HUNTER,
		"TRAIT_UNARMORED_FIGHTER" = TRAIT_UNARMORED_FIGHTER,
		...
		"TRAIT_NICE_SHOT" = TRAIT_NICE_SHOT,
		"TRAIT_JET_JUNKY" = TRAIT_JET_JUNKY,
		"TRAIT_ALCHOLIC" = TRAIT_ALCHOLIC,
		"TRAIT_SMOKER" = TRAIT_SMOKER,
		"TRAIT_MENTAT_ADDICT" = TRAIT_MENTAT_ADDICT,
		"TRAIT_FANNING" = TRAIT_FANNING,
		"TRAIT_FAST_PUMP" = TRAIT_FAST_PUMP,
