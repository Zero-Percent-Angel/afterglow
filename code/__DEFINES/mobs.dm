...
#define BIG_MOB_MIN_PLAYERS 120
///living players needed to jump into medium mobs
#define MED_MOB_MIN_PLAYERS 120
///living players needed to jump into medium mobs
#define SMALL_MOB_MIN_PLAYERS 120
///living players needed to activate full mob ability powers
#define MOB_POWER_FULL_MIN_PLAYERS 120
///living players needed to activate limited mob ability powers
#define MOB_POWER_SOME_MIN_PLAYERS 120
