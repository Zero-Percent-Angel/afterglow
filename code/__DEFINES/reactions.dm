...
#define MIND_ALTERING_CHEMICAL				"MIND"
#define BODY_ALTERING_CHEMICAL				"BODY"
#define CHEMICAL_INTERFERE_IMPOSSIBLE		-100
#define CHEMICAL_INTERFERE_NEVER			0
#define CHEMICAL_INTERFERE_SOMETIMES		4
#define CHEMICAL_INTERFERE_OFTEN			10
#define CHEMICAL_INTERFERE_VERY_OFTEN		30
