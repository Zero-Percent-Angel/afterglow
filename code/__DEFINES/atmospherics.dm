...
GLOBAL_LIST_INIT(the_gases, list(GAS_O2, GAS_N2, GAS_CO2, GAS_PLASMA, GAS_H2O, GAS_HYPERNOB, GAS_NITROUS, GAS_NITRYL, GAS_TRITIUM, GAS_BZ, GAS_STIMULUM, GAS_PLUOXIUM, GAS_MIASMA, GAS_METHANE, GAS_METHYL_BROMIDE))
