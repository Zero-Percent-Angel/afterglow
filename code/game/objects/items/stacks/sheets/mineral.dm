...
GLOBAL_LIST_INIT(titanium_recipes, list ( \
	...
	new/datum/stack_recipe("bear trap", /obj/item/restraints/legcuffs/beartrap, 1, time = 50, skill_threshold = REGULAR_CHECK, skills = list(SKILL_REPAIR, SKILL_OUTDOORSMAN)), \
