...
/obj/structure/closet/secure_closet/hos/PopulateContents()
	...
	new /obj/item/clothing/suit/armor/tiered/medium/duster(src)
...
/obj/structure/closet/secure_closet/security/PopulateContents()
	..()
	new /obj/item/clothing/suit/armor/tiered/medium/vest(src)
...
/obj/structure/closet/secure_closet/armory1/PopulateContents()
	..()
	for(var/i in 1 to 3)
		new /obj/item/clothing/suit/armor/tiered/heavy/tier3/riot(src)
	for(var/i in 1 to 3)
