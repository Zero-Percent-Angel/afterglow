...
/obj/structure/closet/wardrobe/cargotech/PopulateContents()
	new /obj/item/clothing/suit/armor/tiered/hooded/wintercoat/cargo(src)
	for(var/i in 1 to 3)
...
/obj/structure/closet/wardrobe/atmospherics_yellow/PopulateContents()
	...
	for(var/i in 1 to 3)
		new /obj/item/clothing/suit/armor/tiered/hooded/wintercoat/engineering/atmos(src)
	for(var/i in 1 to 3)
...
/obj/structure/closet/wardrobe/engineering_yellow/PopulateContents()
	...
	new /obj/item/storage/backpack/industrial(src)
	new /obj/item/storage/backpack/satchel/eng(src)
	new /obj/item/clothing/suit/armor/tiered/hooded/wintercoat/engineering(src)
	for(var/i in 1 to 3)
...
/obj/structure/closet/wardrobe/white/medical/PopulateContents()
	...
	new /obj/item/clothing/suit/armor/tiered/hooded/wintercoat/medical(src)
...
/obj/structure/closet/wardrobe/science_white/PopulateContents()
	...
	new /obj/item/storage/backpack/satchel/tox(src)
	new /obj/item/clothing/suit/armor/tiered/hooded/wintercoat/science(src)
	for(var/i in 1 to 3)
...
/obj/structure/closet/wardrobe/botanist/PopulateContents()
	...
	new /obj/item/storage/backpack/satchel/hyd(src)
	new /obj/item/clothing/suit/armor/tiered/hooded/wintercoat/hydro(src)
