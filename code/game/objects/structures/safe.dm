...
/obj/structure/safe/ui_interact(mob/user)
	...
	if(open)
		...
		dat += "</table></center>"
	user << browse(HTML_SKELETON("<html><head><meta http-equiv='Content-Type' content='text/html; charset=UTF-8'><title>[name]</title></head><body>[dat]</body></html>"), "window=safe;size=350x300")
...
/obj/structure/safe/Topic(href, href_list)
	...
	if(href_list["retrieve"])
		user << browse(HTML_SKELETON(""), "window=safe") // Close the menu
