...
/datum/preferences/proc/load_character(slot)
	...
	features["tail_lizard"]			= sanitize_inlist(features["tail_lizard"], list(), "None")
	features["tail_human"]			= sanitize_inlist(features["tail_human"], GLOB.list_of_nothing, "None")
	features["snout"]				= sanitize_inlist(features["snout"], GLOB.list_of_nothing, "None")
	features["horns"]				= sanitize_inlist(features["horns"], GLOB.list_of_nothing, "None")
	...
	features["insect_wings"] 		= sanitize_inlist(features["insect_wings"], GLOB.list_of_nothing, "None")
