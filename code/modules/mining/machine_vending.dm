...
/obj/item/storage/backpack/duffelbag/mining_conscript/PopulateContents()
	...
	new /obj/item/clothing/suit/armor/tiered/hooded/explorer(src)
...
/obj/machinery/mineral/equipment_vendor/proc/RedeemSVoucher(obj/item/suit_voucher/voucher, mob/redeemer)
	...
	switch(selection)
		if("Exo-suit")
			new /obj/item/clothing/suit/armor/tiered/hooded/explorer/exo(drop_location)
			new /obj/item/clothing/mask/gas/exo(drop_location)
		if("SEVA suit")
			new /obj/item/clothing/suit/armor/tiered/hooded/explorer/seva(drop_location)
