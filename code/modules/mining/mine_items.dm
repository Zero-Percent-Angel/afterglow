...
/obj/structure/closet/wardrobe/miner/PopulateContents()
	...
	new /obj/item/clothing/gloves/color/black(src)
	new /obj/item/clothing/gloves/color/black(src)
	new /obj/item/clothing/suit/armor/tiered/hooded/wintercoat/miner(src) //yes, even both mining locker types
	new /obj/item/clothing/suit/armor/tiered/hooded/wintercoat/miner(src)
	new /obj/item/clothing/suit/armor/tiered/hooded/wintercoat/miner(src)
...
/obj/structure/closet/secure_closet/miner/PopulateContents()
	...
	new /obj/item/clothing/suit/armor/tiered/hooded/wintercoat/miner(src) //because you know you want it
