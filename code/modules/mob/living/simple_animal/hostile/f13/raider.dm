...
/mob/living/simple_animal/hostile/raider/ranged/boss
	...
	loot = list(/obj/item/gun/ballistic/automatic/smg/greasegun, /obj/effect/spawner/lootdrop/f13/armor/randomraiderhead, /obj/effect/spawner/lootdrop/f13/armor/randomraiderchest, /obj/item/clothing/under/f13/ravenharness, /obj/item/stack/f13Cash/random/high)
	footstep_type = FOOTSTEP_MOB_SHOE
...
/mob/living/simple_animal/hostile/raider/junker/boss
	...
	ranged = TRUE
	rapid_melee = 1
	loot = list(/obj/item/gun/ballistic/rifle/incinerator, /obj/effect/spawner/lootdrop/f13/armor/randomraiderhead, /obj/effect/spawner/lootdrop/f13/armor/randomraiderchest, /obj/item/clothing/under/f13/ravenharness, /obj/item/stack/f13Cash/random/high)
	retreat_distance = 4
	minimum_distance = 6
	extra_projectiles = 2
	ranged_cooldown_time = 2 SECONDS
