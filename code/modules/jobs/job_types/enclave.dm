...
/datum/job/enclave
	...
	enforces = "Enclave rules: Act mature and respectful. Obey orders and always remember you are fighting for the only true legitimate power in this land of savages. Wearing gasmasks outside the compound is encouraged but not required."
...
/datum/outfit/job/enclave/peacekeeper/enclave_default
	name = "Enclave"
...
/datum/outfit/loadout/specialist
...
/datum/outfit/loadout/scientist
	name = "Scientist"
	backpack_contents = list(/obj/item/clothing/under/f13/enclave/science = 1,
							/obj/item/clothing/head/helmet/f13/envirosuit = 1,
