...
/datum/job/oasis/f13mayor   // /obj/item/card/id/captains_spare for any elected mayors. - Blue
	...
	access = list(ACCESS_BAR, ACCESS_MAYOR, ACCESS_OFFICER, ACCESS_CLONING, ACCESS_GATEWAY, ACCESS_CARGO_BOT, ACCESS_MINT_VAULT, ACCESS_CLINIC, ACCESS_KITCHEN, ACCESS_MINING, ACCESS_FORENSICS_LOCKERS, ACCESS_MEDICAL, ACCESS_SECURITY)
	minimal_access = list(ACCESS_BAR, ACCESS_MAYOR, ACCESS_OFFICER, ACCESS_CLONING, ACCESS_GATEWAY, ACCESS_CARGO_BOT, ACCESS_MINT_VAULT, ACCESS_KITCHEN, ACCESS_CLINIC, ACCESS_MINING, ACCESS_FORENSICS_LOCKERS, ACCESS_MEDICAL, ACCESS_SECURITY)
...
/datum/outfit/job/den/f13mayor
	...
	suit = /obj/item/clothing/suit/armor/tiered/light/duster/town/coat
	head = /obj/item/clothing/head/helmet/f13/town/mayor
	backpack_contents = list(
		/obj/item/storage/pill_bottle/chem_tin/radx,
...
/datum/job/oasis/f13secretary
	...
	access = list(ACCESS_BAR, ACCESS_MAYOR, ACCESS_CLONING, ACCESS_GATEWAY, ACCESS_CARGO_BOT, ACCESS_MINT_VAULT, ACCESS_CLINIC, ACCESS_KITCHEN, ACCESS_MINING, ACCESS_FORENSICS_LOCKERS, ACCESS_MEDICAL)
	minimal_access = list(ACCESS_BAR, ACCESS_MAYOR, ACCESS_CLONING, ACCESS_GATEWAY, ACCESS_CARGO_BOT, ACCESS_MINT_VAULT, ACCESS_KITCHEN, ACCESS_CLINIC, ACCESS_MINING, ACCESS_FORENSICS_LOCKERS, ACCESS_MEDICAL)
	matchmaking_allowed = list(
		/datum/matchmaking_pref/friend = list(
			/datum/job/oasis
		),
...
/datum/job/oasis/f13sheriff
	...
	access = list(ACCESS_BAR, ACCESS_CLONING, ACCESS_GATEWAY, ACCESS_CARGO_BOT, ACCESS_MINT_VAULT, ACCESS_KITCHEN, ACCESS_MINING, ACCESS_FORENSICS_LOCKERS, ACCESS_CLINIC, ACCESS_MEDICAL, ACCESS_OFFICER, ACCESS_SECURITY)
	minimal_access = list(ACCESS_BAR, ACCESS_CLONING, ACCESS_GATEWAY, ACCESS_CARGO_BOT, ACCESS_MINT_VAULT, ACCESS_CLINIC, ACCESS_KITCHEN, ACCESS_MINING, ACCESS_FORENSICS_LOCKERS, ACCESS_CLINIC, ACCESS_MEDICAL, ACCESS_OFFICER, ACCESS_SECURITY)
	matchmaking_allowed = list(
		/datum/matchmaking_pref/friend = list(
			/datum/job/oasis
		),
...
/datum/outfit/smutant/town/police
	suit = /obj/item/clothing/suit/armor/tiered/medium/duster/mutie
...
/datum/outfit/loadout/thelaw
	name = "The Law Man"
	suit = /obj/item/clothing/suit/armor/tiered/medium/town/riot
	head = /obj/item/clothing/head/helmet/f13/town/sheriff
...
/datum/outfit/loadout/frontierjustice
	...
	suit = /obj/item/clothing/suit/armor/tiered/medium/duster/deputy
...
/datum/job/oasis/f13dendoc
	...
	access = list(ACCESS_BAR, ACCESS_CLINIC, ACCESS_CLONING, ACCESS_MEDICAL)
	minimal_access = list(ACCESS_BAR, ACCESS_CLINIC, ACCESS_CLONING, ACCESS_MEDICAL)
	matchmaking_allowed = list(
		/datum/matchmaking_pref/friend = list(
			/datum/job/oasis
		),
...
/datum/outfit/loadout/frontier
	...
	suit = /obj/item/clothing/suit/armor/tiered/light/duster/town/bartender
