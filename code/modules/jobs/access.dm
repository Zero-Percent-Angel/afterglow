...
/proc/get_all_accesses()
	return list(ACCESS_VAULT_F13, ACCESS_SECURITY, ACCESS_SEC_DOORS, ACCESS_BRIG, ACCESS_ARMORY, ACCESS_FORENSICS_LOCKERS, ACCESS_COURT, ACCESS_ENTER_GENPOP, ACCESS_LEAVE_GENPOP,
...
/proc/get_all_jobs()
	return list("Centurion", "NCR Captain", "Overseer", "Sheriff",
				...
				"Veteran Decanus", "Vexillarius", "Decanus", "Veteran Legionary", "Prime Legionary",
